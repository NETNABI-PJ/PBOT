...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    GPIO_InitStruct.Pin = LIGHT_CTRL_DAC1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(LIGHT_CTRL_DAC1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    HAL_GPIO_DeInit(LIGHT_CTRL_DAC1_GPIO_Port, LIGHT_CTRL_DAC1_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = LCD_MT_SPI2_NSS_Pin|LCD_MT_SPI2_SCK_Pin|LCD_MT_SPI2_MISO_Pin|LCD_MT_SPI2_MISOB15_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PC12     ------> SPI3_MOSI
    */
    GPIO_InitStruct.Pin = LCD_EL_SPI3_NSS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
    HAL_GPIO_Init(LCD_EL_SPI3_NSS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LCD_EL_SPI3_SCK_Pin|LCD_EL_SPI3_MISO_Pin|LCD_EL_SPI3_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
  ...
  */
    ...
    PE6     ------> SPI4_MOSI
    */
    GPIO_InitStruct.Pin = LCD_ER_SPI4_SCK_Pin|LCD_ER_SPI4_NSS_Pin|LCD_ER_SPI4_MISO_Pin|LCD_ER_SPI4_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, LCD_MT_SPI2_NSS_Pin|LCD_MT_SPI2_SCK_Pin|LCD_MT_SPI2_MISO_Pin|LCD_MT_SPI2_MISOB15_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(LCD_EL_SPI3_NSS_GPIO_Port, LCD_EL_SPI3_NSS_Pin);

    HAL_GPIO_DeInit(GPIOC, LCD_EL_SPI3_SCK_Pin|LCD_EL_SPI3_MISO_Pin|LCD_EL_SPI3_MOSI_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, LCD_ER_SPI4_SCK_Pin|LCD_ER_SPI4_NSS_Pin|LCD_ER_SPI4_MISO_Pin|LCD_ER_SPI4_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC8     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = LCD_MT_TIM3_CH1_Pin|LCD_EL_TIM3_CH2_Pin|LCD_ER_TIM3_CH3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
